...
- [📜 Remix Config for `assetsBuildDirectory`](https://remix.run/docs/en/main/file-conventions/remix-config#assetsbuilddirectory){:target=”_blank”} (this is how you configure where Remix puts fingerprinted assets)
